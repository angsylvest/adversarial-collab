...
# plot each scenario in train 
results_path = "trains/"

csv_files = ['run-2024-11-20_14-50-28_experiment_asymmetric_advantages_alg_baseline_lazy_(False, 0.5)_adver_(True, 0.5)_include_[True, True, True, True]-tag-Reward_train.csv', 
'run-2024-11-21_17-14-29_experiment_asymmetric_advantages_alg_multiTravos_disc_True_adapt_False_UPDATED_lazy_(False, 0.5)_adver_(True, 0.5)_include_[True, True, True, True]-tag-Reward_train.csv']
...
# now plot each scenario in eval 