...
class PlayerState(object):
    ...
    def update_trust_info(self, trust_dict): 
    ...
    def update_adv_trust(self, success=False):
        """ Update the trust score based on whether the interaction was adversarial or not. """
        if success:
            self.beta_adversary += 1  # Adversarial interaction -> increase β
        else:
    ...
    def update_lazy_trust(self, success=False):
        """ Update the trust score based on whether the interaction was adversarial or not. """
        if success:
            self.beta_lazy += 1  # Adversarial interaction -> increase β
        else:
...
class OvercookedGridworld(object):
    ...
    def resolve_interacts(self, new_state, joint_action, events_infos, info=None):
        ...
        adversary_idx = 1  # Assuming the adversarial agent is player 1 (index 1)
